...
- 레벨이 높아질수록 블록이 점점 더 빨리 내려오며, 높은 점수를 얻기 위해서는 빠른 반응과 전략이 필요합니다.
- 게임은 모든 플레이어가 게임을 마칠 때까지 계속됩니다.
...
- 모두 게임을 마치면 각 플레이어에게 게임 결과가 전송됩니다.
...
<img width="381" alt="image" src="https://github.com/soyeonii/Multi_Tetris/assets/69310195/31ac218d-dfe9-4428-9d80-bd0b829556b1">
...
- mutex               : 서버 측에서 스레드 간의 동기화 문제가 발생하지 않도록 해줍니다.
- condition variable  : 스레드가 대기 모드에 있다가 두 명이 들어오면 게임을 시작하도록 합니다.
- signal              : Active Close(CTRL+C)를 금지합니다.
- fork                : 게임 진행 후 다시 원래의 화면으로 돌아오도록 합니다.
- selct               : 테트리스 시작 화면에서 별이 반짝이는 효과를 위해 비동기적 입력을 받습니다.
